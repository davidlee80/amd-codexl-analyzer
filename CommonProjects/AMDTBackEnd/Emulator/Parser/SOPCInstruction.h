...
public:
    ...
    /// ctor
    SOPCInstruction(SSRC ssrc0, SSRC ssrc1, unsigned int sridx0, unsigned int sridx1, int iLabel, int iGotoLabel): Instruction(SOPCInstructionWidth, ScalarALU, InstructionSet_SOPC, iLabel, iGotoLabel),
...
public:
    ...
    /// ctor
    SISOPCInstruction(SSRC ssrc0, SSRC ssrc1, OP op, unsigned int sridx0, unsigned int sridx1, int iLabel, int iGotoLabel): SOPCInstruction(ssrc0, ssrc1, sridx0, sridx1, iLabel, iGotoLabel), m_op(op) {}
...
public:
    ...
    /// ctor
    VISOPCInstruction(SSRC ssrc0, SSRC ssrc1, OP op, unsigned int sridx0, unsigned int sridx1, int iLabel, int iGotoLabel): SOPCInstruction(ssrc0, ssrc1, sridx0, sridx1, iLabel, iGotoLabel), m_op(op)
    {
