...
public:
    ...
    /// ctor
    EXPInstruction(EN en, TGT tgt, COMPR compr, DONE done, VM vm, VSRC vsrc0, VSRC vsrc1, VSRC vsrc2, VSRC vsrc3, int iLabel, int iGotoLabel): Instruction(EXPInstructionWidth, Export, InstructionSet_EXP, iLabel, iGotoLabel),
