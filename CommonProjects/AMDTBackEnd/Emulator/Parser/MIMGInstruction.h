...
public:
    ...
    MIMGInstruction(DMASK dmask, UNORM unorm, GLC glc, DA da, R128 r128, TFE tfe, LWE lwe, SLC slc, VADDR vaddr, VDATA vdata, SRSRC srsrc,
                    SSAMP ssamp, Instruction::InstructionCategory inst, int iLabel, int iGotoLabel): Instruction(MIMGInstructionWidth, inst, InstructionSet_MIMG, iLabel, iGotoLabel),
...
public:
    ...
    SIMIMGInstruction(DMASK dmask, UNORM unorm, GLC glc, DA da, R128 r128, TFE tfe, LWE lwe, OP op, SLC slc, VADDR vaddr, VDATA vdata, SRSRC srsrc,
                      SSAMP ssamp, Instruction::InstructionCategory inst, int iLabel, int iGotoLabel): MIMGInstruction(dmask, unorm, glc, da, r128, tfe, lwe, slc, vaddr, vdata, srsrc, ssamp, inst, iLabel, iGotoLabel), m_op(op) {}
