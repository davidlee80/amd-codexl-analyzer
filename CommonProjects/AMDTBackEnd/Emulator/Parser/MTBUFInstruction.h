...
public:
    ...
    MTBUFInstruction(OFFSET offset, OFFEN offen, IDXEN idxen, GLC glc, ADDR64 addr64, DFMT dmft, NFMT nmft, VADDR vaddr, VDATA vdata, SRSRC srsrc,
                     SLC slc, TFE tfe, SOFFSET soffset, unsigned int ridx, Instruction::InstructionCategory inst, int iLabel, int iGotoLabel): Instruction(MTBUFInstructionWidth, inst, InstructionSet_MTBUF, iLabel, iGotoLabel),
...
public:
    ...
    SIMTBUFInstruction(OFFSET offset, OFFEN offen, IDXEN idxen, GLC glc, ADDR64 addr64, OP op, DFMT dmft, NFMT nmft, VADDR vaddr, VDATA vdata, SRSRC srsrc,
                       SLC slc, TFE tfe, SOFFSET soffset, unsigned int ridx, Instruction::InstructionCategory inst, int iLabel, int iGotoLabel): MTBUFInstruction(offset, offen, idxen, glc, addr64, dmft, nmft, vaddr, vdata, srsrc,
