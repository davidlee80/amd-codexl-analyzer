...
OA_API gtString oaGetDriverVersion(int& driverError)
{
    ...
    {
        // Get the procedure for the cal function:
        osProcedureAddress driverVersionFunction = nullptr;
        osProcedureAddress adlCreateFunction = nullptr;
        osProcedureAddress adlDestroyFunction  = nullptr;
        ...
        GT_IF_WITH_ASSERT(rc && createrc && destroyrc && (driverVersionFunction != nullptr) && (adlCreateFunction != nullptr) && (adlDestroyFunction != nullptr))
        {
            // Init ADL:
