...
#if (GR_BUILD_TARGET == GR_WINDOWS_OS) || ((GR_BUILD_TARGET == GR_LINUX_OS) && (GR_LINUX_VARIANT == GR_GENERIC_LINUX_VARIANT))
...
#if GR_LINUX_VARIANT == GR_GENERIC_LINUX_VARIANT || GR_LINUX_VARIANT == GR_ANDROID_LINUX_VARIANT
...
#if GR_LINUX_VARIANT == GR_ANDROID_LINUX_VARIANT
    // Drawable handle:
...
#endif // GR_BUILD_TARGET == GR_LINUX_OS
