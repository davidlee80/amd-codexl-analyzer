...
/// \file $File: //devtools/branch/OpenSourceExp/Common/Src/CElf/Src/CElfSymbolTable.cpp $
/// \version $Revision: #1 $
/// \brief  A set of classes to allow easy manipulation of ELF
///         binaries in memory.
//
//=====================================================================
// $Id: //devtools/branch/OpenSourceExp/Common/Src/CElf/Src/CElfSymbolTable.cpp#1 $
