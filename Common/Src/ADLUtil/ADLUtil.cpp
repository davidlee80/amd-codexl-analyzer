//=====================================================================
/// Copyright 2011-2016 (c) Advanced Micro Devices, Inc. 
///
/// \author GPU Developer Tools
/// \file    ADLUtil.cpp 
/// \brief   ADL interface functions.
//=====================================================================
...
#undef LOCAL_GET_PROC_ADDRESS
        ...
        if (ADL_SUCCESS == result)
        {
            ...
            if (NULL != m_ADL2_Main_Control_Create)
            {
...
ADLUtil_Result AMDTADLUtils::Unload()
{
    ...
    if (NULL != m_libHandle)
    {
        if (NULL != m_ADL2_Main_Control_Destroy)
        {
            m_ADL2_Main_Control_Destroy(m_adlContext);
            m_adlContext = NULL;
        }
        else if (NULL != m_ADL_Main_Control_Destroy)
        {
...
ADLUtil_Result AMDTADLUtils::GetAsicInfoList(AsicInfoList& asicInfoList)
{
    ...
    if (ADL_RESULT_NONE == m_asicInfoListRetVal)
    {
        ...
        if (ADL_SUCCESS == m_asicInfoListRetVal)
        {
            ...
            if (NULL != m_ADL2_Adapter_NumberOfAdapters_Get)
            {
            ...
            else
            {
                if (0 < numAdapter)
                {
                    ...
                    if (NULL != m_ADL2_Adapter_AdapterInfo_Get)
                    {
...
ADLUtil_Result AMDTADLUtils::GetADLVersionsInfo(ADLVersionsInfo& adlVersionInfo)
{
    ...
    if (ADL_RESULT_NONE == m_versionRetVal)
    {
        ...
        if (ADL_SUCCESS == m_versionRetVal)
        {
            ...
            // Obtain the number of adapters for the system
            if (NULL != m_ADL2_Graphics_Versions_Get)
            {
    ...
    if (ADL_SUCCESS == result)
    {
        ...
        for (AsicInfoList::iterator it = asicInfoList.begin(); it != asicInfoList.end(); ++it)
        {
            ...
            if (forceHigh)
            {
                ...
                if (NULL != m_ADL2_Overdrive5_ODParameters_Get)
                {
                ...
                if (0 < perfLevelSize)
                {
                    ...
                    if (NULL != m_ADL2_Overdrive5_ODPerformanceLevels_Get)
                    {
                    ...
                    if (ADL_OK <= adlResult)
                    {
                        ...
                        if (NULL != m_ADL2_Overdrive5_ODPerformanceLevels_Set)
                        {
